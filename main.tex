...
% Table data
What we do is right & Delivering the best possible outcome for customers with integrity and transparency 
    & \begin{enumerate}
        \item Covered up corrupt financial planners that did not deliver the good outcomes for customers \cite{barker17}
      \end{enumerate} 
    
    & Did not act with transparency and honesty. Was fined  \\
\hline
...
\hline
We are dedicated to service & Care for the customer and serve them by doing the right thing & \begin{enumerate}
        \item Incentivised unethical behaviour of financial planners by rewarding it with commissions and bonuses for high performances \cite{gordon18}
        \item Created a performance based sales culture for financial planners that did not align with doing right by custoemrs \cite{gordon18}
    \end{enumerate}
    & \begin{enumerate}
        \item Financial planners were not acting on the best interests of customers, often putting investments into high risk and high reward funds
    \end{enumerate} \\
\hline
We pursue excellence & Provide a service with high standard of quality, encourage constructive feedback and learn from mistakes 
    & \begin{enumerate}
        \item Appointed Matt Comyn as CEO, despite his possible involvement with anti-money laundering scandal \cite{dickson18}
    \end{enumerate} 
    & \begin{enumerate}
        \item CBA looks to still put profit before customers and did not learn from mistakes \cite{dickson18}
    \end{enumerate}\\
\hline
We get things done & Fix problems quickly, make timely decisions and focus on great outcomes & & \\
\hline
\end{longtable}
